package com.alfanthariq.skeleton.features.common;
...
public class DotsFadeView extends LinearLayout {
    ...
    public DotsFadeView(Context context) {
        super(context);
    }

    public DotsFadeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public DotsFadeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
